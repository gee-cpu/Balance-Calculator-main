...
//get user Balance.
  ...
  const handleRandomString = () => {
    ...
    var config = {
      method: "post",
      url: "http://localhost:8081/operations/operationTypes?userName=test@test.com&operationType=RANDOM_STRING&operationDto=randomStringUrl&=\n",
      headers: {
  ...
  useEffect(() => {
    ...
    if (query.num1 !== "" && query.num2 !== "" && query.operationType !== "") {
      ...
      const config = {
        method: "post",
        url: `http://localhost:8081/operations/operationTypes?userName=${savedEmail}&operationType=${operationValue}&operationDto=num1&operationDto=num2`,
        headers: {
          "Content-Type": "application/json",
        },
        data: data,
